...
1. dos下运行
win32
ifort /Qmkl mkl_lapack95.lib test1Dem.f90 ave.f90 ddx.f90 sdiag.f90 /link /stack:100000000
test1Dem.exe

x64环境
ifort /Qmkl mkl_lapack95_lp64.lib test1Dem.f90 ave.f90 ddx.f90 sdiag.f90 /link /stack:100000000
test1Dem.exe
